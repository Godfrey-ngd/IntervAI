...
class QwenTtsServiceTest {
    ...
    void setUp() {
        ...
        VoiceInterviewProperties.QwenTtsConfig ttsConfig = properties.getQwen().getTts();
        ttsConfig.setModel("qwen3-tts-flash-realtime");
        ttsConfig.setApiKey("test-api-key");
        ttsConfig.setVoice("Cherry");
        ttsConfig.setFormat("pcm");
        ttsConfig.setSampleRate(16000);
        ttsConfig.setMode("server_commit");
        ttsConfig.setLanguageType("Chinese");
        ttsConfig.setSpeechRate(1.0f);
        ttsConfig.setVolume(60);
